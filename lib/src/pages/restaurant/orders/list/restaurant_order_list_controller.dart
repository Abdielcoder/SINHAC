...
import 'package:lavador/src/pages/restaurant/orders/detail/restaurant_orders_detail_page.dart';
...
class RestaurantOrdersListController {
  ...
  List<String> status = ['PAGADO','CASH', 'DESPACHADO', 'EN CAMINO', 'ENTREGADO'];
