...
import 'package:lavador/src/pages/restaurant/orders/detail/restaurant_orders_detail_controller.dart';
...
class _RestaurantOrdersDetailPageState extends State<RestaurantOrdersDetailPage> {
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              _con.order.status == 'CASH' ? _dropDown(_con.users) : Container(),
              ...
              _con.order.status == 'CASH' ? _buttonNext() : Container()
            ],
          ),
        ),
      ),
  ...
  Widget _textDescription() {
    return Container(
      ...
      child: Text(
        _con.order == 'PAGADO' ? 'Asignar lavador' : 'Lavador asignado',
  ...
  Widget _buttonNext() {
    return Container(
      margin: EdgeInsets.only(left: 35, right: 30, top: 5, bottom: 20),
