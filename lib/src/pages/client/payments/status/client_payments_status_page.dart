...
import 'package:lavador/src/pages/client/payments/status/client_payments_status_controller.dart';
...
class _ClientPaymentsStatusPageState extends State<ClientPaymentsStatusPage> {
  ...
  Widget _textCardStatus() {
    return Container(
      ...
      child: Text(
        'Mira el estado de tu compra en la seccion de MIS SERVICIOS',
        style: TextStyle(
          fontSize: 17
        ),
        textAlign: TextAlign.center,
