...
import 'package:lavador/src/models/mercado_pago_installment.dart';
import 'package:lavador/src/models/mercado_pago_issuer.dart';
import 'package:lavador/src/models/mercado_pago_payment.dart';
import 'package:lavador/src/models/mercado_pago_payment_method_installments.dart';
...
class ClientPaymentsInstallmentsController {
  ...
  Future init(BuildContext context, Function refresh) async {
    ...
    address = Addresss.fromJson(await _sharedPref.read('address'));
