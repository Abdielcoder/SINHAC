...
import 'package:lavador/src/pages/client/orders/detail/client_orders_detail_controller.dart';
...
class _ClientOrdersDetailPageState extends State<ClientOrdersDetailPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              SizedBox(height: 10),
              _textData('Lavador:', '${_con.order?.delivery?.name ?? 'No asignado'} ${_con.order?.delivery?.lastname ?? ''}'),
      ...
      : NoDataWidget(text: 'Ningun servicio agregado',),
    );
  }
