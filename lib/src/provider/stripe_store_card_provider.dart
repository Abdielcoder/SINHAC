...
class StripeService {
  ...
  static String secret = 'sk_test_51KfEMnE9FN5SXSt4IY3N3VbkKepk1IQjrC7DqiA3dY63Mg4yIDsRt7q55yr4eO7ag6D7Jwv5bC4osqGUbGaqWkHs00sjnLVA01';
  ...
  static Future<Map<String, dynamic>> createPaymentIntent(String amount, String currency) async {
    try {
      ...
      Uri paymentApiUrl = Uri.https('api.stripe.com','v1/payment_intents');
