...
class UsersProvider {
  ...
  Future<ResponseApi> logout(String idUser) async {
    try {
      ...
      print('logout id value 3: ${idUser}');
      Map<String, String> headers = {
        'Content-type': 'application/json'
      };
  ...
  Future<ResponseApi> create(User user) async {
    try {
      print("InsertaGoogleBD :2");
      Uri url = Uri.http(_url, '$_api/create/back');
  ...
  Future<ResponseApi> cretabada(User user) async {
    try {
      Uri url = Uri.http(_url, '$_api/cretabada');
      String bodyParams = json.encode(user);
      Map<String, String> headers = {
        'Content-type': 'application/json'
      };
